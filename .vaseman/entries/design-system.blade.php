...
@section('content')
    ...
    <div class="container py-5 mt-5">
        ...
        <div class="mb-4">
            ...
            <div>
                <button type="button" class="btn btn-feature btn-lg">feature</button>
                <button type="button" class="btn btn-feature">feature</button>
                <button type="button" class="btn btn-feature btn-sm">feature</button>
                <button type="button" class="btn btn-feature btn-lg btn-arrow">feature btn-arrow</button>
                <button type="button" class="btn btn-feature btn-arrow">feature btn-arrow</button>
                <button type="button" class="btn btn-feature btn-sm btn-arrow">feature btn-arrow</button>
            </div>
        </div>
        ...
        <div class="typographies row my-4">
            ...
            <div class="col-4">
                ...
                <div class="bs-component">
                    ...
                    @foreach($themeColors as $themeColor)
                        <p class="text-{{$themeColor}}">Fusce dapibus, tellus ac cursus commodo, tortor mauris nibh.</p>
                    @endforeach
                </div>
            </div>
        </div>
